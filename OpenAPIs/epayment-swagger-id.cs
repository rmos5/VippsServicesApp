...
namespace VippsApi
{
    ...
    {
        private string _baseUrl = "https://api.vipps.no";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public EPayment(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <br/>See [idempotency](https://developer.vippsmobilepay.com/docs/common-topics/http-headers#idempotency)</param>
        /// <param name="ocp_Apim_Subscription_Key">The Azure API Management subscription key.
        /// <br/>See: https://developer.vippsmobilepay.com/docs/APIs/access-token-api</param>
        /// <param name="vipps_System_Name">The name of the ecommerce solution.
        /// <br/>One word in lowercase letters is good.
        /// <br/>See [http-headers](https://developer.vippsmobilepay.com/docs/common-topics/http-headers).</param>
        ...
        public virtual async System.Threading.Tasks.Task<CreatePaymentResponse> CreatePaymentAsync(CreatePaymentRequest body, string idempotency_Key, string ocp_Apim_Subscription_Key, string merchant_Serial_Number, string vipps_System_Name, string vipps_System_Version, string vipps_System_Plugin_Name, string vipps_System_Plugin_Version, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/epayment/v1/payments");
        ...
        /// </remarks>
        /// <param name="reference">The primary reference when creating the payment.
        /// <br/>Similar to orderId in the eCom API.
        /// <br/>See [orderid](https://developer.vippsmobilepay.com/docs/common-topics/orderid).</param>
        /// <param name="ocp_Apim_Subscription_Key">The Azure API Management subscription key.
        /// <br/>See: https://developer.vippsmobilepay.com/docs/APIs/access-token-api</param>
        ...
        public virtual async System.Threading.Tasks.Task<GetPaymentResponse> GetPaymentAsync(string reference, string merchant_Serial_Number, string ocp_Apim_Subscription_Key, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/epayment/v1/payments/{reference}");
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<PaymentEvent>> GetPaymentEventLogAsync(string reference, string merchant_Serial_Number, string ocp_Apim_Subscription_Key, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/epayment/v1/payments/{reference}/events");
            urlBuilder_.Replace("{reference}", System.Uri.EscapeDataString(ConvertToString(reference, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            return CancelPaymentAsync(reference, merchant_Serial_Number, ocp_Apim_Subscription_Key, idempotency_Key, vipps_System_Name, vipps_System_Version, vipps_System_Plugin_Name, vipps_System_Plugin_Version, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<ModificationResponse> CancelPaymentAsync(string reference, string merchant_Serial_Number, string ocp_Apim_Subscription_Key, string idempotency_Key, string vipps_System_Name, string vipps_System_Version, string vipps_System_Plugin_Name, string vipps_System_Plugin_Version, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/epayment/v1/payments/{reference}/cancel");
            urlBuilder_.Replace("{reference}", System.Uri.EscapeDataString(ConvertToString(reference, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    if (vipps_System_Plugin_Version != null)
                        request_.Headers.TryAddWithoutValidation("Vipps-System-Plugin-Version", ConvertToString(vipps_System_Plugin_Version, System.Globalization.CultureInfo.InvariantCulture));
                    request_.Content = new System.Net.Http.StringContent(string.Empty, System.Text.Encoding.UTF8, "application/problem+json");
                    request_.Method = new System.Net.Http.HttpMethod("POST");
        ...
        public virtual async System.Threading.Tasks.Task<ModificationResponse> CapturePaymentAsync(CaptureModificationRequest body, string reference, string merchant_Serial_Number, string ocp_Apim_Subscription_Key, string idempotency_Key, string vipps_System_Name, string vipps_System_Version, string vipps_System_Plugin_Name, string vipps_System_Plugin_Version, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/epayment/v1/payments/{reference}/capture");
            urlBuilder_.Replace("{reference}", System.Uri.EscapeDataString(ConvertToString(reference, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<ModificationResponse> RefundPaymentAsync(RefundModificationRequest body, string reference, string merchant_Serial_Number, string ocp_Apim_Subscription_Key, string idempotency_Key, string vipps_System_Name, string vipps_System_Version, string vipps_System_Plugin_Name, string vipps_System_Plugin_Version, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/epayment/v1/payments/{reference}/refund");
            urlBuilder_.Replace("{reference}", System.Uri.EscapeDataString(ConvertToString(reference, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <br/>without the use of the Vipps MobilePay app. This is useful for automated testing.
        ...
        /// <br/>in the Vipps MobilePay app before this endpoint can be used for that user.
        /// </remarks>
        ...
        public virtual async System.Threading.Tasks.Task ForceApproveAsync(ForceApprove body, string reference, string merchant_Serial_Number, string ocp_Apim_Subscription_Key, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/epayment/v1/test/payments/{reference}/approve");
            urlBuilder_.Replace("{reference}", System.Uri.EscapeDataString(ConvertToString(reference, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    /// <summary>
    /// The customer's token, if it is available. This token will be obtained when a user scans a static QR
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.2.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    public partial class CreatePaymentRequest
    {
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public CreatePaymentRequestCustomerInteraction CustomerInteraction { get; set; } = VippsApi.CreatePaymentRequestCustomerInteraction.CUSTOMER_NOT_PRESENT;
    ...
    public partial class GetPaymentResponse
    {
        ...
        /// <br/>See: https://developer.vippsmobilepay.com/docs/common-topics/landing-page/
        /// </summary>
        [Newtonsoft.Json.JsonProperty("redirectUrl", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Uri RedirectUrl { get; set; }
    ...
    /// <br/>See https://developer.vippsmobilepay.com/docs/common-topics/errors
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.2.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    public partial class QrFormat
    {
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public QrFormatFormat Format { get; set; } = VippsApi.QrFormatFormat.IMAGE_SVG_XML;
